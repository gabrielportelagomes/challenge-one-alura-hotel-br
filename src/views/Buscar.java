...
public class Buscar extends JFrame {
	...
	public Buscar() {
		...
		panel.addTab("Reservas", new ImageIcon(Buscar.class.getResource("/images/reservado.png")), scroll_table, null);
		...
		panel.addTab("Huéspedes", new ImageIcon(Buscar.class.getResource("/images/pessoas.png")), scroll_tableHuespedes, null);
